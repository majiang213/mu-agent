...
export function fg(r: number, g: number, b: number) { return (s: string) => `\x1b[38;2;${r};${g};${b}m${s}${R}`; }
export function fgK(r: number, g: number, b: number) { return (s: string) => `\x1b[38;2;${r};${g};${b}m${s}${RF}`; }
export function bold(s: string) { return `\x1b[1m${s}\x1b[22m`; }
export function dim(s: string) { return `\x1b[2m${s}\x1b[22m`; }
export function italic(s: string) { return `\x1b[3m${s}\x1b[23m`; }
